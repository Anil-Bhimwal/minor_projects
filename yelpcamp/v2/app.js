...
var Campground =  mongoose.model("Campground",campgroundSchema);//creating a model that we can use, we can use it with different methods here we will use find method
// Campground.create(
//     {
//         name :"Granite Hill",
